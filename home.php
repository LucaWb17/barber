      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="@container">
              <div class="@[480px]:p-4">
                <div
                  ...
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuBZkf7IB_dP3Z6DyJKkBxjOlXzILWIUIDrCa6XugNxbo3OT8J9gNZUCmq4saAeXeX26L7quQNZ_pQbpYiamGSV4jYYYqS-pEO1GvrpgDqWuTjldNkDNbDpcRRmbAqmBODgc2f1dB_oY1owx2PoMI28YOAbUdKjcBbiKZX0V0G_Tu1pbvwAB_5VYbot6egzoTApqf_Dwq4DmCLI29QuaIn0BgPdAvNJYN6osQPGhhODo3IlDvkakuAZi7xb8yldAy372tHAs9_8s4g");'
                >
            ...
            <h2 class="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">About Clipper</h2>
            <p class="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
              At Clipper, we're more than just a barbershop; we're a community. Our expert barbers are dedicated to providing personalized grooming experiences, ensuring every
