...
//     error_log("Database configuration is missing on locations.php.");
// }
?>
<html>
  <head>
    ...
    />
    <title>Our Locations - Clipper</title>
      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <!-- Main Content for Locations Page -->
            <div class="p-4">
              <h1 class="text-white text-[32px] font-bold leading-tight mb-4">Our Locations</h1>
              <p class="text-[#c5a296] text-lg leading-normal">
                Information about our locations will be available here soon.
              </p>
              <p class="text-[#c5a296] text-md leading-normal mt-4">
                We are working on expanding and will update this page with details of our branches.
              </p>
            </div>
            <!-- End Main Content -->
          </div>
