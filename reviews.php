          ...
          <div class="flex flex-1 justify-end gap-8">
            <label class="flex flex-col min-w-40 !h-10 max-w-64">
              <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                <div
                  class="text-[#c5a296] flex border-none bg-[#452e26] items-center justify-center pl-4 rounded-l-xl border-r-0"
                ...
                <input
                  placeholder="Search"
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border-none bg-[#452e26] focus:border-none h-full placeholder:text-[#c5a296] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                  value=""
                />
              </div>
            </label>
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-white tracking-light text-[32px] font-bold leading-tight">Our Barbers</p>
                <p class="text-[#c5a296] text-sm font-normal leading-normal">
                  Meet our talented team of barbers, each with their unique style and expertise. Find the perfect barber for your next haircut.
                </p>
              </div>
            </div>
            ...
            <div class="flex px-4 py-3 justify-center">
              ...
              >
                <span class="truncate">See All Reviews</span>
              </button>
            </div>
          </div>
        </div>
