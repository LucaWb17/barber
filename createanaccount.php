    ...
    >
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <form action="php/auth/register.php" method="POST" class="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
            ...
            <p class="text-[#c5a296] text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center">Already have an account? <a href="login.php" class="underline">Log in</a></p>
          </form>
        </div>
      </div>
    </div>
